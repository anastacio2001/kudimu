...
const NewHistoryScreen = () => {
  ...
  const fetchAllData = async () => {
    try {
      ...
      const mockMedals = [
        { id: 1, name: 'Primeiro Passos', description: 'Completou primeira campanha', icon: '🏁', earned: true },
        { id: 2, name: 'Dedicado', description: '10 campanhas completadas', icon: '🔥', earned: true },
        { id: 3, name: 'Especialista', description: '50 campanhas completadas', icon: '🎯', earned: false }
      ];

      const mockCampaignHistory = [
        {
          id: 1,
          titulo: 'Pesquisa sobre Mobilidade Urbana',
          status: 'concluida',
        ...
        {
          id: 2,
          titulo: 'Opinião sobre E-commerce',
          status: 'concluida',
          data_resposta: '2025-10-18',
          recompensa: 300,
          tempo_resposta: 240,
          validada: 1
        },
        {
          id: 3,
          titulo: 'Pesquisa de Mercado Alimentar',
          status: 'pendente',
          data_resposta: '2025-10-15',
          recompensa: 200,
          tempo_resposta: 120,
          validada: 0
        }
      ...
      setCampaignHistory(mockCampaignHistory);
      setError(null);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Carregando seu histórico...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Acompanhe sua jornada e conquistas</p>
              </div>
            </div>
            <ReputationBadge
              level={userData?.nivel}
              points={userData?.reputacao}
              size="large"
            />
          </div>
        </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-2xl font-semibold text-gray-900 dark:text-white">
                          {userData?.saldo_pontos?.toFixed(2)} AOA
                        </p>
                      </div>
                    </div>
                  </div>
