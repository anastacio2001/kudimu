...
export default function LoginScreen({ onLoginSuccess, navigateTo }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (userData.success) {
          // Usar callback do AppRouter para fazer login
          onLoginSuccess(userData.data);
        } else {
          // Fallback se não conseguir dados do usuário
    ...
    <div className="login-container">
      <div className="login-box">
        ...
        <div className="login-footer">
          <p>
            Não tem uma conta?{' '}
            <a href="/cadastro" onClick={(e) => { e.preventDefault(); navigateTo('/cadastro'); }}>
              Cadastre-se
            </a>
          </p>
        </div>
